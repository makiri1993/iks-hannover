  ...
  <Page>
    ...
    <CenteredText>
      ...
      <PflegedienstP>
        ...
        <StyledBR />
        <StyledBR />
        Der Interkulturelle Sozialdienst sieht sich in der Verpflichtung, sein Handeln regelmäßig zu überprüfen und überprüfen zu lassen, um
        eine gleichbleibend hohe Pflegequalität zu gewährleisten.
        <StyledBR />
        <StyledBR />
      ...
      <PflegedienstP>
        ...
        der Pflegebedürftige einen Pflegedienst in Anspruch nimmt (Sachleistung), sich von Angehörigen, Freunden oder Nachbarn pflegen lässt
        (Pflegegeld) oder in eine stationäre Einrichtung zieht:
      </PflegedienstP>
    </CenteredText>
    ...
    <CenteredText>
      <PflegedienstP>
        ...
        <StyledBR />
        <StyledBR />
        Übersteigt die Summe der gewählten Leistungskomplexe den Zuschussbetrag der Pflegekasse, muss der so genannte „Eigenanteil“ entweder
        privat oder über den Träger der Sozialsicherung (Stadt oder Region) finanziert werden.
        <StyledBR />
        <StyledBR />
      ...
      <PflegedienstP>
        ...
        <StyledBR />
        <StyledBR />
        Für alle medizinischen Leistungen (auch Behandlungspflege genannt), die der Haus- oder Facharzt verordnet, gilt, dass die Kosten von
        der Krankenkasse übernommen werden, sofern die Verordnung genehmigt wurde.
        <StyledBR />
        <StyledBR />
      ...
      <PflegedienstP>
        ...
        Bereich der Wundversorgung bei unseren Kunden übernehmen, sich stets weiterbilden, um auf dem aktuellen Wissenstand zu sein und
        zudem eng mit den entsprechenden Haus- und Fachärzten zusammenarbeiten.
      </PflegedienstP>
      <StyledBR />
    </CenteredText>
    <DivCenterRow>
