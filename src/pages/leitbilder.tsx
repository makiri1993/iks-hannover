  ...
  <Page>
    ...
    <Container>
      ...
      <CenteredPLeftWithMargin>
        ...
        Kultur ist die Summe der Werte und Traditionen der Gesellschaften. Wir verpflichten uns, die Werte und Traditionen unserer Klienten
        zu respektieren, auch wenn es nicht die unseren sind. Wir begründen unser Handeln auf der Basis dieser Motive:
      </CenteredPLeftWithMargin>
      <CenteredPLeftWithMargin>
        Neue Arbeits- und Organisationsformen zu entwickeln, um unsere Ideal-Vorstellungen von „Arbeit“ zu verwirklichen.
      </CenteredPLeftWithMargin>
      <CenteredPLeftWithMargin>
        Durch unser tägliches Handeln die Gesellschaft zu sensibilisieren für die Bereiche „Alter“, „Pflege“ und „Migration“. Damit möchten
        wir einen aktiven Beitrag gegen Ausgrenzung und Rassismus leisten.
      </CenteredPLeftWithMargin>
      <CenteredPLeftWithMargin>
      ...
      <CenteredPLeftWithMarginInOrange>Der Mensch</CenteredPLeftWithMarginInOrange>
      <CenteredPLeftWithMargin>
        Wir verpflichten uns des ganzheitlichen Handelns nach dem biographischen Ansatz. Wir möchten dort anknüpfen, wo der Mensch meint, zu
        stehen. Wir akzeptieren und respektieren dadurch verschiedene vorhandene Realitäten, die nicht unserer Realität entsprechen müssen.
        Die Realität des Patienten ist die Grundlage unserer Realität im Pflegeprozess. Pflegeprozess ist immer auch „Pflege-im-Prozess“ und
        damit „Pflege in Beziehung“.
      </CenteredPLeftWithMargin>
      ...
      <CenteredPLeftWithMargin>
        Alle in diesem Unternehmen arbeitenden Menschen sind verpflichtet, einen respektierlichen und wertschätzenden Umgang miteinander zu
        pflegen. Die leitenden Mitarbeiter des Unternehmens sind verpflichtet, ein Arbeitsklima zu schaffen, das von gegenseitigem Vertrauen
        geprägt und frei von Angst und Repression ist.
      </CenteredPLeftWithMargin>
