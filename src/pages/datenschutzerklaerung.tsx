  ...
  <Layout>
    <Page>
      ...
      <Container>
        ...
        <CenteredPLeftWithMargin>
          Im Folgenden finden Sie Informationen darüber, wie wir diese Daten erfassen, für uns nutzen und schützen. Bitte nehmen Sie sich
          kurz Zeit, um die folgenden Angaben sorgfältig durchzulesen.
        </CenteredPLeftWithMargin>
        ...
        <CenteredPLeftWithMargin>
          Des Weiteren steht es Ihnen zu, sich jederzeit bei der zuständigen Aufsichtsbehörde zu beschweren, falls Sie der Meinung sind,
          Ihre personenbezogenen Daten werden nicht gemäß der Datenschutzgesetze verarbeitet. Wir wären Ihnen trotzdem sehr dankbar, wenn
          Sie sich in diesem Fall zuerst an unseren Datenschutzbeauftragten wenden.
        </CenteredPLeftWithMargin>
        ...
        <CenteredPLeftWithMargin>
          ...
          Kommunikation per E-Mail) keine abschließend sichere Übertragung von Daten garantiert werden kann. Empfindliche Daten sollten
          daher entweder gar nicht oder nur über eine sichere Verbindung (SSL) über das Internet übertragen werden.
        </CenteredPLeftWithMargin>
