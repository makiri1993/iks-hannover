  ...
  <Layout>
    ...
    <div className='max-container'>
      <div className='text-container'>
        ...
        <Heading size={4} orange>Herzlich willkommen auf unserer Webseite.</Heading>
        ...
        <Heading size={4} orange>Erhebung und Verarbeitung von Daten</Heading>
        <Text>
          Jeder Besuch unserer Webseite wird erfasst. Dabei werden folgende Daten automatisch gespeichert:
        </Text>
        <ul>
          <li className='color-orange'><Text>Aufgerufene Webseite,</Text></li>
          <li className='color-orange'><Text>Unterseite, oder Datei</Text></li>
          <li className='color-orange'><Text>Datum und Uhrzeit und Dauer des Abrufs</Text></li>
          <li className='color-orange'><Text>IP-Adresse</Text></li>
          <li className='color-orange'><Text>Übertragene Datenmenge</Text></li>
          <li className='color-orange'><Text>Verwendetes Betriebssystem</Text></li>
          <li className='color-orange'><Text>Browser und Browsertyp Die Internetseite, von der weitergeleitet wurde</Text></li>
        </ul>
        <Text>
        ...
        <Heading size={4} orange>Nutzung und Weitergabe personenbezogener Daten</Heading>
        <Text>
        ...
        <Heading size={4} orange>Betroffenenrechte</Heading>
        <Text>
        ...
        <Heading size={4} orange>Schutz der gespeicherten Daten</Heading>
        <Text>
        ...
        <Heading size={4} orange>Speicherung anonymisierter Daten/Cookies</Heading>
        <Text>
        ...
        <Heading size={4} orange>Örtlich Beauftragter für den Datenschutz</Heading>
        <Text>
